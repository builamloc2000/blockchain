...
class DappWalletConnectTransport extends beacon_transport_walletconnect_1.WalletConnectTransport {
    constructor(name, keyPair, storage, wcOptions, isLeader) {
        super(name, keyPair, storage, beacon_types_1.StorageKey.TRANSPORT_WALLETCONNECT_PEERS_DAPP, wcOptions, isLeader);
        this.client.listenForChannelOpening((peer) => __awaiter(this, void 0, void 0, function* () {
            yield this.addPeer(peer);
            this._isConnected = (0, beacon_ui_1.isMobileOS)(window) || (yield isLeader())
                ? beacon_types_1.TransportStatus.CONNECTED
                : beacon_types_1.TransportStatus.SECONDARY_TAB_CONNECTED;

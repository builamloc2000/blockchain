...
class TzktBlockExplorer extends block_explorer_1.BlockExplorer {
    constructor(rpcUrls = {
        ...
        [beacon_types_1.NetworkType.PARISNET]: 'https://parisnet.tzkt.io',
        [beacon_types_1.NetworkType.CUSTOM]: 'https://parisnet.tzkt.io',
        [beacon_types_1.NetworkType.QUEBECNET]: 'https://quebecnet.tzkt.io'
    }) {
        super(rpcUrls);

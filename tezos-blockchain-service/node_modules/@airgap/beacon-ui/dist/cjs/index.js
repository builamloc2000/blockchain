...
const webList = [{
  ...
  "links": {
    ...
    "parisnet": "https://metamask.tezos.com/",
    "quebecnet": "https://metamask.tezos.com/"
  }
}, {
  "key": "kukai_web",
  "name": "Kukai Wallet",
  ...
  "links": {
    ...
    "parisnet": "https://parisnet.kukai.app",
    "quebecnet": "https://quebecnet.kukai.app"
  }
}, {
  "key": "tzsafe",
  "name": "TzSafe",
  ...
  "links": {
    ...
    "parisnet": "https://ghostnet.tzsafe.marigold.dev",
    "quebecnet": "https://ghostnet.tzsafe.marigold.dev"
  }
}];
const iOSList = [{
  "key": "airgap_ios",
...
var _tmpl$$a = /*#__PURE__*/web.template(`<div class=loader>`);
const Loader = _ => {
  return _tmpl$$a();
};

var _tmpl$$9 = /*#__PURE__*/web.template(`<div><div><div class=alert-header><div class=alert-logo></div><div class=alert-button-icon></div></div><div class=alert-modal-loading-wrapper></div><div class=alert-body>`),
  _tmpl$2$8 = /*#__PURE__*/web.template(`<div class=alert-button-icon>`),
  _tmpl$3$8 = /*#__PURE__*/web.template(`<div class=alert-button-icon-empty>`),
  _tmpl$4$7 = /*#__PURE__*/web.template(`<div>`),
  _tmpl$5$5 = /*#__PURE__*/web.template(`<div class=alert-divider>`),
  _tmpl$6$4 = /*#__PURE__*/web.template(`<div class=alert-footer>`);
const Alert = props => {
  ...
  return (() => {
    ...
    web.insert(_el$3, (() => {
      var _c$ = web.memo(() => !!props.onBackClick);
      return () => _c$() && (() => {
        var _el$8 = _tmpl$2$8();
    ...
    web.insert(_el$3, (() => {
      var _c$2 = web.memo(() => !!!props.onBackClick);
      return () => _c$2() && _tmpl$3$8();
    })(), _el$4);
    ...
    web.insert(_el$7, !isMobile && (() => {
      var _el$10 = _tmpl$4$7();
      web.insert(_el$10, (() => {
        var _c$4 = web.memo(() => !!props.extraContent);
    ...
    web.insert(_el$2, (() => {
      var _c$3 = web.memo(() => !!(!isMobile && props.extraContent));
      return () => _c$3() && (() => {
    ...
    web.effect(_p$ => {
      var _v$ = props.open ? 'alert-wrapper-show' : 'alert-wrapper-hide',
      ...
      _p$.a = web.style(_el$6, _v$3, _p$.a);
      _v$4 !== _p$.o && ((_p$.o = _v$4) != null ? _el$7.style.setProperty("margin-bottom", _v$4) : _el$7.style.removeProperty("margin-bottom"));
      return _p$;
    }, {
      e: undefined,
      t: undefined,
  ...
  return (() => {
    ...
    web.insert(_el$, (() => {
      ...
      return () => _c$() && (() => {
        ...
        web.insert(_el$3, (() => {
          var _c$3 = web.memo(() => !!props.description);
          return () => _c$3() && (() => {
            var _el$7 = _tmpl$3$7();
        ...
        web.insert(_el$3, (() => {
          var _c$4 = web.memo(() => !!(props.tags && props.tags.length > 0));
          return () => _c$4() && (() => {
            var _el$8 = _tmpl$4$6();
        ...
        web.effect(_p$ => {
          var _v$ = `wallet-main ${props.mobile ? 'wallet-main-mobile' : ''}`,
          ...
          _v$3 !== _p$.a && web.setAttribute(_el$6, "src", _p$.a = _v$3);
          return _p$;
        }, {
          e: undefined,
          t: undefined,
...
var styles$7 = ".top-wallets-wrapper {\n  margin-bottom: 1.8em;\n}\n\n.top-wallets-info {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.theme__dark .top-wallets-info h3 {\n  color: white;\n}\n\n.theme__dark .top-wallets-info span {\n  color: #b5b8be;\n}\n\n.theme__dark .top-wallets-other-wallets-left h3 {\n  color: white;\n}\n\n.top-wallets-info h3 {\n  text-align: center;\n  color: #334155;\n  margin: 0px;\n  font-size: 0.938rem;\n}\n\n.top-wallets-info span {\n  text-align: center;\n  max-width: 300px;\n  font-size: 0.8em;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.35em;\n  margin: 6px 0px 12px 0px;\n}\n\n.top-wallets-learn-more {\n  text-decoration: underline;\n  cursor: pointer;\n  font-size: 0.95em !important;\n}\n\n.top-wallets-wallets-main {\n  margin-top: 1em;\n  grid-template-columns: repeat(2, 1fr);\n  display: grid;\n  gap: 1em;\n}\n\n.top-wallets-other-wallets {\n  display: flex;\n  gap: 1.25em;\n  justify-content: space-between;\n  border-radius: 12px;\n  padding: 1.25em;\n  cursor: pointer;\n  transition: all ease 0.2s;\n\n  -webkit-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  -moz-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n}\n\n.top-wallets-other-wallets-left {\n  max-width: 148px;\n}\n\n.top-wallets-other-wallets-left h3 {\n  color: #334155;\n  margin: 0px;\n  font-size: 1em;\n}\n\n.top-wallets-other-wallets-left p {\n  max-width: 400px;\n  font-size: 0.85em;\n  font-weight: 300;\n  color: #94a3b8;\n  line-height: 1.35em;\n  margin: 0px;\n  font-size: 0.75em;\n}\n\n.top-wallets-other-wallets-right {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.top-wallets-other-wallets-right img {\n  border-radius: 8px;\n  width: 2.4em;\n  height: 2.4em;\n  -webkit-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  -moz-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n}\n\n.top-wallets-other-wallets-center-wallet {\n  transform: perspective(500px) translateZ(100px);\n}\n\n@media only screen and (max-width: 800px) {\n  .top-wallets-info h3 {\n    font-size: 1em;\n  }\n\n  .top-wallets-info p {\n    font-size: 0.75em;\n  }\n\n  .top-wallets-other-wallets {\n    flex-direction: column;\n    text-align: center;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .top-wallets-other-wallets-left {\n    order: 1;\n  }\n\n  .top-wallets-other-wallets-left h3 {\n    font-size: 0.85em;\n  }\n\n  .top-wallets-other-wallets-left p {\n    font-size: 0.65em;\n  }\n}\n\n@media only screen and (max-width: 400px) {\n  .top-wallets-other-wallets-right {\n    max-width: 50px;\n    transform: scale(0.8);\n  }\n}\n";

var _tmpl$$7 = /*#__PURE__*/web.template(`<div class=top-wallets-wrapper><div class=top-wallets-info><h3>Connect Wallet</h3></div><div class=top-wallets-wallets-main>`),
  _tmpl$2$6 = /*#__PURE__*/web.template(`<span>Do you wish to report a bug? <span class=top-wallets-learn-more>Click here`),
  _tmpl$3$6 = /*#__PURE__*/web.template(`<span>If you don't have a wallet, you can select a provider and create one now. <span class=top-wallets-learn-more>Learn more`),
  _tmpl$4$5 = /*#__PURE__*/web.template(`<div class=top-wallets-other-wallets><div class=top-wallets-other-wallets-left><h3>Other Wallets</h3><p>See other wallets you can use to connect</p></div><div class=top-wallets-other-wallets-right><img><img class=top-wallets-other-wallets-center-wallet><img>`);
const TopWallets = props => {
  const enableBugReport = localStorage ? localStorage.getItem(beaconTypes.StorageKey.ENABLE_METRICS) : 'false';
  return (() => {
    var _el$ = _tmpl$$7(),
      _el$2 = _el$.firstChild;
      _el$2.firstChild;
      var _el$4 = _el$2.nextSibling;
    web.insert(_el$2, enableBugReport === 'true' && (() => {
      var _el$5 = _tmpl$2$6(),
        _el$6 = _el$5.firstChild,
        _el$8 = _el$6.nextSibling;
      _el$8.$$click = () => props.onClickLearnMore();
      return _el$5;
    })(), null);
    web.insert(_el$2, enableBugReport !== 'true' && (() => {
      var _el$9 = _tmpl$3$6(),
      ...
      _el$12.$$click = () => props.onClickLearnMore();
      return _el$9;
    })(), null);
    ...
    web.insert(_el$4, (() => {
      var _c$ = web.memo(() => !!props.otherWallets);
      return () => _c$() && (() => {
        var _el$13 = _tmpl$4$5(),
        ...
        web.effect(_p$ => {
          var _v$ = props.otherWallets.images[0],
            _v$2 = props.otherWallets.images[1],
            _v$3 = props.otherWallets.images[2];
          _v$ !== _p$.e && web.setAttribute(_el$16, "src", _p$.e = _v$);
          _v$2 !== _p$.t && web.setAttribute(_el$17, "src", _p$.t = _v$2);
          _v$3 !== _p$.a && web.setAttribute(_el$18, "src", _p$.a = _v$3);
          return _p$;
        }, {
          e: undefined,
          t: undefined,
...
var styles$5 = ".info-wrapper {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n  border-radius: 10px;\n  padding: 30px;\n}\n\n.info-border {\n  border: 1px solid #aaaaaa42;\n}\n\n.info-icon {\n  width: 40px;\n  height: 40px;\n  border-radius: 6px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-size: 28px;\n  margin-bottom: 0.2rem;\n}\n\n.info-badge {\n  background-color: #3880ff;\n  font-size: 38px;\n  -webkit-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  -moz-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n}\n\n.theme__dark .info-title {\n  color: white;\n}\n\n.theme__dark .info-description {\n  color: #aeaeae;\n}\n\n.info-title {\n  text-align: center;\n  color: #334155;\n  margin: 0px;\n  font-size: 16px;\n}\n\n.info-description {\n  text-align: center;\n  font-size: 12.8px;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.25rem;\n  margin: 6px 0px 12px 0px;\n  margin: 0px;\n  max-width: 300px;\n}\n\n.info-data {\n  font-size: 12.8px;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.25rem;\n  margin: 6px 0px 12px 0px;\n  margin: 0px;\n  overflow: scroll;\n  max-height: 300px;\n}\n\n.info-buttons {\n  display: flex;\n  align-items: center;\n  gap: 0.6rem;\n}\n\n.info-button {\n  border-radius: 6px;\n  background-color: #3880ff;\n  border: 1px solid #3880ff;\n  color: white;\n  padding: 0.6rem 1.2rem;\n  width: 180px;\n  transition: all ease 0.2s;\n  cursor: pointer;\n  margin-top: 1rem;\n  font-size: 12.8px;\n}\n\n.info-button:hover {\n  background-color: #166afc;\n}\n\n.info-button-secondary {\n  border-radius: 6px;\n  background-color: transparent;\n  border: 1px solid #3880ff;\n  color: #3880ff;\n  padding: 0.6em 1.2rem;\n  width: 180px;\n  transition: all ease 0.2s;\n  cursor: pointer;\n  margin-top: 1rem;\n}\n\n.info-button-secondary:hover {\n  background-color: #e8f0ff;\n}\n\n.downloadLink {\n  text-decoration: none;\n  color: gray;\n  font-size: smaller;\n  padding: 0.5rem;\n}\n\nbutton#qr-code-icon {\n  background-color: transparent;\n  border: none;\n  min-width: 2.5rem;\n  align-self: self-end;\n  position: absolute;\n  top: 0.3rem;\n  right: 0.3rem;\n}\n\n@media only screen and (max-width: 300px) {\n  button#qr-code-icon {\n    min-width: 1.5rem;\n  }\n}\n\n@media only screen and (max-width: 800px) {\n  .info-title {\n    font-size: 14.4px;\n    line-height: 1rem;\n  }\n\n  .info-description {\n    font-size: 0.65rem;\n  }\n\n  .qr-more-info {\n    font-size: 0.75rem;\n  }\n\n  .info-wrapper {\n    max-height: 180px;\n    padding: 1.2em;\n    position: relative;\n  }\n\n  .info-icon {\n    width: 40px;\n    height: 40px;\n    font-size: 1.8rem;\n  }\n\n  .info-button {\n    padding: 0.5em 1.6em;\n    font-size: 16px;\n    font-weight: bold;\n  }\n}\n";

var _tmpl$$5 = /*#__PURE__*/web.template(`<div><h3 class=info-title></h3><div class=info-buttons>`),
  _tmpl$2$5 = /*#__PURE__*/web.template(`<div>`),
  _tmpl$3$5 = /*#__PURE__*/web.template(`<div class=info-description>`),
  _tmpl$4$4 = /*#__PURE__*/web.template(`<pre class=info-data>`),
  _tmpl$5$3 = /*#__PURE__*/web.template(`<button>`),
  _tmpl$6$2 = /*#__PURE__*/web.template(`<a class=downloadLink>`),
  _tmpl$7$2 = /*#__PURE__*/web.template(`<button id=qr-code-icon>`);
const Info = props => {
  return (() => {
    var _el$ = _tmpl$$5(),
      _el$2 = _el$.firstChild,
      _el$3 = _el$2.nextSibling;
    web.insert(_el$, (() => {
      var _c$ = web.memo(() => !!props.icon);
      return () => _c$() && (() => {
        var _el$4 = _tmpl$2$5();
        web.insert(_el$4, () => props.icon);
        web.effect(_p$ => {
          var _v$ = `info-icon ${props.iconBadge ? 'info-badge' : ''}`,
            _v$2 = props.bigIcon ? {
              'font-size': '3.4em'
            } : {};
    ...
    web.insert(_el$, (() => {
      var _c$4 = web.memo(() => !!props.downloadLink);
      return () => _c$4() && (() => {
        var _el$8 = _tmpl$6$2();
        web.insert(_el$8, () => props.downloadLink.label);
        web.effect(() => web.setAttribute(_el$8, "href", props.downloadLink.url));
        return _el$8;
      })();
    })(), null);
    web.insert(_el$, (() => {
      var _c$5 = web.memo(() => !!props.onShowQRCodeClick);
      return () => _c$5() && (() => {
        var _el$9 = _tmpl$7$2();
        _el$9.$$click = () => props.onShowQRCodeClick && props.onShowQRCodeClick();
        web.insert(_el$9, web.createComponent(QRCodeIcon, {}));
        return _el$9;
      })();
    })(), null);
...
const logger$2 = new beaconCore.Logger('QR');
/**
...
const getQrData = (payload, height, width) => {
  if (payload.length > 500) {
    logger$2.warn('getQrData', 'The size of the payload in the QR code is quite long and some devices might not be able to scan it anymore. To reduce the QR size, try using a shorter "name", "appUrl" and "iconUrl"');
  }
  try {
...
const QR = props => {
  ...
  return (() => {
    var _el$ = _tmpl$$4(),
      ...
      _el$3 = _el$2.nextSibling;
    web.insert(_el$2, (() => {
      var _c$ = web.memo(() => !!!props.isMobile);
      return () => _c$() && _tmpl$2$4();
    })(), null);
    web.insert(_el$2, (() => {
      var _c$2 = web.memo(() => !!!props.isMobile);
      return () => _c$2() && (() => {
        var _el$5 = _tmpl$3$4();
    ...
    web.insert(_el$2, (() => {
      var _c$3 = web.memo(() => !!props.isMobile);
      return () => _c$3() && (() => {
        var _el$6 = _tmpl$3$4();
        web.insert(_el$6, () => `Scan QR code with a ${props.isWalletConnect ? 'WalletConnect' : 'Beacon'}-compatible wallet.`);
        return _el$6;
      })();
    })(), null);
    ...
    web.insert(_el$3, (() => {
      var _c$4 = web.memo(() => !!copied());
      return () => _c$4() && _tmpl$4$3();
    })(), null);
    web.insert(_el$3, (() => {
      var _c$5 = web.memo(() => !!!copied());
      return () => _c$5() && _tmpl$5$2();
    })(), null);
    web.effect(_p$ => {
      var _v$ = props.isMobile ? {
          'flex-direction': 'column',
          'align-items': 'center',
          'justify-content': 'center',
          height: '340px',
...
const currentOS = () => {
  ...
  var osMap = new Map([['Windows', 'Windows'], ['Mac', 'Mac OS'], ['Linux', 'Linux'], ['iPhone', 'iOS'], ['iPad', 'iOS'], ['Android', 'Android']]);
...
const currentBrowser = () => {
  var ua = navigator.userAgent;
  var browserMap = new Map([['Firefox', 'Firefox'], ['Opera', 'Opera'], ['OPR', 'Opera'], ['Trident', 'Internet Explorer'], ['Edge', 'Edge'], ['Chrome', 'Chrome'], ['Safari', 'Safari']]);
...
var _tmpl$$3 = /*#__PURE__*/web.template(`<div><span class=pair-other-info>Select QR Type</span><br>`),
  _tmpl$2$3 = /*#__PURE__*/web.template(`<button class=wallets-button>Beacon`),
  _tmpl$3$3 = /*#__PURE__*/web.template(`<button class=wallets-button>WalletConnect`);
...
const PairOther = props => {
  ...
  return [web.memo(() => web.memo(() => uiState() === 'selection')() && (() => {
    var _el$ = _tmpl$$3(),
      _el$2 = _el$.firstChild;
      _el$2.nextSibling;
    web.insert(_el$, (() => {
      var _c$ = web.memo(() => !!hasBeacon());
      return () => _c$() && (() => {
        var _el$4 = _tmpl$2$3();
        _el$4.$$click = () => {
    ...
    web.insert(_el$, (() => {
      var _c$2 = web.memo(() => !!hasWalletConnect());
      return () => _c$2() && (() => {
        var _el$5 = _tmpl$3$3();
        _el$5.$$click = () => {
    ...
    return _el$;
  })()), web.memo(() => web.memo(() => !!(uiState() !== 'selection' && !!qrData()))() && web.createComponent(QR, {
    get isWalletConnect() {
...
var _tmpl$$2 = /*#__PURE__*/web.template(`<form class=form-style><div class=input-group><label for=title class=label-style>Title</label><input type=text id=title></div><div class=input-group><label for=description class=label-style>Description</label><textarea id=description></textarea></div><div class=input-group><label for=steps class=label-style>Steps to Reproduce</label><textarea id=steps></textarea></div><div class=permissions-group><label for=user-premissions>You agree to share anonymous data with the developers.</label><input id=user-premissions type=checkbox></div><button type=submit>`),
  _tmpl$2$2 = /*#__PURE__*/web.template(`<label class=error-label>`),
  _tmpl$3$2 = /*#__PURE__*/web.template(`<span>`),
  _tmpl$4$2 = /*#__PURE__*/web.template(`<div class=thank-you-message>`);
const logger$1 = new beaconCore.Logger('BugReport');
const BugReportForm = props => {
  const [title, setTitle] = solidJs.createSignal('');
  const [titleTouched, setTitleTouched] = solidJs.createSignal(false);
  const [titleErrorMsg, setTitleErrorMsg] = solidJs.createSignal('');
  const [description, setDescription] = solidJs.createSignal('');
  const [descriptionTouched, setDescriptionTouched] = solidJs.createSignal(false);
  const [descriptionErrorMsg, setDescriptionErrorMsg] = solidJs.createSignal('');
  const [steps, setSteps] = solidJs.createSignal('');
  const [stepsTouched, setStepsTouched] = solidJs.createSignal(false);
  const [stepsErrorMsg, setStepsErrorMsg] = solidJs.createSignal('');
  const [isFormValid, setFormValid] = solidJs.createSignal(false);
  const [isLoading, setIsLoading] = solidJs.createSignal(false);
  const [didUserAllow, setDidUserAllow] = solidJs.createSignal(false);
  const [status, setStatus] = solidJs.createSignal(null);
  const [showThankYou, setShowThankYou] = solidJs.createSignal(false);
  const db = new beaconCore.IndexedDBStorage('beacon', 'bug_report');
  const isTitleValid = () => {
  ...
  const areStepsValid = () => {
    ...
    const invalidText = check ? '' : 'Write at least 30 characters to describe the steps to reproduce.';
  ...
  const indexDBToMetadata = async () => {
    ...
    try {
      ...
      logger$1.error('indexDBToMetadata', 'getAll failed: ', error.message);
      return [beaconResult, wcResult];
    }
    if (keys.length && values.length && keys.length === values.length) {
      keys.forEach((key, i) => (key.includes('beacon') ? beaconResult : wcResult)[key] = values[i]);
    }
    return [beaconResult, wcResult];
  };
  const getUserId = () => {
  ...
  const handleSubmit = async event => {
    ...
    const request = {
      userId: beaconState[beaconTypes.StorageKey.USER_ID] && beaconState[beaconTypes.StorageKey.USER_ID].length ? beaconState[beaconTypes.StorageKey.USER_ID] : getUserId(),
      title: title(),
      sdkVersion: beaconCore.SDK_VERSION,
    ...
    fetch('https://beacon-backend.prod.gke.papers.tech/bug-report/save', options).then(response => {
      if (!response.ok) {
  ...
  return (() => {
    ...
    web.insert(_el$2, (() => {
      var _c$ = web.memo(() => !!(titleTouched() && titleErrorMsg().length));
      return () => _c$() && (() => {
        var _el$15 = _tmpl$2$2();
        web.insert(_el$15, titleErrorMsg);
        return _el$15;
      })();
    })(), null);
    ...
    web.insert(_el$5, (() => {
      var _c$2 = web.memo(() => !!(descriptionTouched() && descriptionErrorMsg().length));
      return () => _c$2() && (() => {
        var _el$16 = _tmpl$2$2();
        web.insert(_el$16, descriptionErrorMsg);
        return _el$16;
      })();
    })(), null);
    ...
    web.insert(_el$8, (() => {
      var _c$3 = web.memo(() => !!(stepsTouched() && stepsErrorMsg().length));
      return () => _c$3() && (() => {
        var _el$17 = _tmpl$2$2();
        web.insert(_el$17, stepsErrorMsg);
        return _el$17;
      })();
    })(), null);
    _el$13.addEventListener("change", () => setDidUserAllow(prev => !prev));
    web.insert(_el$14, (() => {
      var _c$4 = web.memo(() => !!(!isLoading() && !status()));
      return () => _c$4() ? 'Submit' : "\xA0";
    })(), null);
    web.insert(_el$14, (() => {
      var _c$5 = web.memo(() => !!(!isLoading() && status()));
      return () => _c$5() && (() => {
        var _el$18 = _tmpl$3$2();
        web.insert(_el$18, () => status() === 'success' ? '✓' : '✕');
        web.effect(() => web.className(_el$18, status() === 'success' ? 'icon success-icon' : 'icon error-icon'));
        return _el$18;
      })();
    })(), null);
    web.insert(_el$14, (() => {
      var _c$6 = web.memo(() => !!showThankYou());
      return () => _c$6() && (() => {
        var _el$19 = _tmpl$4$2();
        web.insert(_el$19, web.createComponent(solidJs.For, {
          get each() {
            return 'Thank You!'.split('');
          },
          children: (letter, index) => (() => {
            var _el$20 = _tmpl$3$2();
            web.insert(_el$20, letter);
            web.effect(_$p => (_$p = `${index() * 0.1}s`) != null ? _el$20.style.setProperty("animation-delay", _$p) : _el$20.style.removeProperty("animation-delay"));
            return _el$20;
          })()
        }));
        return _el$19;
    ...
    web.effect(_p$ => {
      var _v$ = `input-style ${titleTouched() && titleErrorMsg().length ? 'invalid' : ''}`,
        _v$2 = `textarea-style ${descriptionTouched() && descriptionErrorMsg().length ? 'invalid' : ''}`,
        _v$3 = `textarea-style ${stepsTouched() && stepsErrorMsg().length ? 'invalid' : ''}`,
        _v$4 = !isFormValid(),
        _v$5 = `button-style ${isFormValid() ? 'valid' : 'invalid'} ${isLoading() ? 'button-loading' : ''}`;
      _v$ !== _p$.e && web.className(_el$4, _p$.e = _v$);
      _v$2 !== _p$.t && web.className(_el$7, _p$.t = _v$2);
      _v$3 !== _p$.a && web.className(_el$10, _p$.a = _v$3);
      _v$4 !== _p$.o && (_el$14.disabled = _p$.o = _v$4);
      _v$5 !== _p$.i && web.className(_el$14, _p$.i = _v$5);
      return _p$;
    }, {
      e: undefined,
      t: undefined,
    ...
    web.effect(() => _el$4.value = title());
    web.effect(() => _el$7.value = description());
    web.effect(() => _el$10.value = steps());
    return _el$;
  })();
};

var _tmpl$$1 = /*#__PURE__*/web.template(`<h3>A network error occurred.`),
  _tmpl$2$1 = /*#__PURE__*/web.template(`<h4>This issue does not concern your wallet or dApp. If the problem persists, please report it to the Beacon team <span>here`),
  _tmpl$3$1 = /*#__PURE__*/web.template(`<span>`),
  _tmpl$4$1 = /*#__PURE__*/web.template(`<div>`),
  _tmpl$5$1 = /*#__PURE__*/web.template(`<div><div></div><div></div><div>`),
...
const logger = new beaconCore.Logger('Alert');
// State variables
...
const [displayQrExtra, setDisplayQrExtra] = solidJs.createSignal(false);
const [pairingExpired, setPairingExpired] = solidJs.createSignal(false);
const [isWCWorking, setIsWCWorking] = solidJs.createSignal(true);
let dispose$1 = null;
/**
...
const openAlert = async config => {
  ...
  const areMetricsEnabled = localStorage ? localStorage.getItem(beaconTypes.StorageKey.ENABLE_METRICS) === 'true' : false;
  ...
  if (!isOpen$1()) {
    ...
    !config.title.toLowerCase().includes('error') && localStorage.removeItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET);
    // Shadow root
    ...
    const setInstallState = wallet => {
      if (!wallet || wallet.types.length <= 1 && !wallet.types.includes('ios') && !wallet.types.includes('desktop') || _isMobileOS && wallet.types.length === 1 && wallet.types.includes('desktop')) {
        return;
      }
    ...
    const updateSelectedWalletWithURL = url => {
      let wallet = JSON.parse(localStorage.getItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET) ?? '{}');
      if (!wallet.key) {
        return;
      }
      wallet = {
      ...
      localStorage.setItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET, JSON.stringify(wallet));
    };
    const generateLink = async () => {
      const uri = (await wcPayload)?.uri ?? '';
      // check whether the uri contains a valid symmetric key or not
      if (!utils.parseUri(uri).symKey) {
        setIsWCWorking(false);
      }
      return uri;
    };
    const generateWCError = title => {
      const errorMessage = localStorage ? localStorage.getItem(beaconTypes.StorageKey.WC_INIT_ERROR) : undefined;
      const description = [(() => {
        var _el$ = _tmpl$$1();
        _el$.style.setProperty("color", "#FF4136");
        _el$.style.setProperty("margin", "0.6px");
        return _el$;
      })(), (() => {
        var _el$2 = _tmpl$2$1(),
          _el$3 = _el$2.firstChild,
          _el$5 = _el$3.nextSibling;
        _el$5.$$click = () => setCurrentInfo('help');
        _el$5.style.setProperty("text-decoration", "underline");
        _el$5.style.setProperty("color", "#007bff");
        _el$5.style.setProperty("cursor", "pointer");
        return _el$2;
      })(), errorMessage && (() => {
        var _el$6 = _tmpl$3$1();
        web.insert(_el$6, errorMessage);
        return _el$6;
      })()];
    ...
    const handleNewTab = async (config, wallet) => {
      ...
      let link = '';
      if (wallet.supportedInteractionStandards?.includes('wallet_connect') && !wallet.name.toLowerCase().includes('kukai')) {
      ...
      localStorage.setItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET, JSON.stringify({
        key: wallet.key,
        name: wallet.name,
        type: 'web',
    ...
    const handleDeepLinking = async (wallet, uri) => {
      localStorage.setItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET, JSON.stringify({
        key: wallet.key,
        type: 'mobile',
        icon: wallet.image
      ...
      if (!wallet.links[OSLink.IOS].length) {
        const syncCode = currentWallet()?.supportedInteractionStandards?.includes('wallet_connect') ? (await wcPayload)?.uri ?? '' : await new beaconCore.Serializer().serialize(await p2pPayload);
        if (!syncCode.length) {
          handleCloseAlert();
          return;
        }
    ...
    const handleClickWallet = async id => {
      ...
      if (wallet && wallet.supportedInteractionStandards?.includes('wallet_connect')) {
        ...
        if (config.pairingPayload) {
          const serializer = new beaconCore.Serializer();
          const code = await serializer.serialize(await p2pPayload);
          const link = getTzip10Link(isIOS(window) && wallet.deepLink ? wallet.deepLink : isAndroid(window) ? wallet.links[OSLink.IOS] : 'tezos://', code);
    ...
    const QRCode = ({
      ...
      const isConnected = !currentWallet()?.supportedInteractionStandards?.includes('wallet_connect') || isWCWorking();
      return web.memo(() => isConnected ? web.createComponent(QR, {
        get isWalletConnect() {
    ...
    dispose$1 = web.render(() => (() => {
      var _el$7 = _tmpl$4$1();
      web.className(_el$7, `theme__${colorMode}`);
      web.insert(_el$7, web.createComponent(AlertResize, {}), null);
      web.insert(_el$7, (() => {
        var _c$ = web.memo(() => !!config.pairingPayload);
        return () => _c$() && web.createComponent(Alert, {
          ...
          get content() {
            return (() => {
              ...
              web.insert(_el$8, (() => {
                var _c$3 = web.memo(() => currentInfo() === 'install');
                return () => _c$3() && (() => {
                  var _el$12 = _tmpl$4$1();
                  web.insert(_el$12, (() => {
                    var _c$5 = web.memo(() => !!(isOnline && currentWallet()?.types.includes('web')));
                    return () => _c$5() && web.createComponent(Info, {
                      border: true,
                      get title() {
                        return `Connect with ${currentWallet()?.name} Web`;
                      },
                  ...
                  web.insert(_el$12, (() => {
                    var _c$6 = web.memo(() => !!(!isMobile() && currentWallet()?.types.includes('extension')));
                    return () => _c$6() && web.createComponent(Info, {
                      border: true,
                      get title() {
                        return web.memo(() => !!hasExtension())() ? `Connect with ${currentWallet()?.name} Browser Extension` : `Install ${currentWallet()?.name} Wallet`;
                      },
                      get description() {
                  ...
                  web.insert(_el$12, (() => {
                    var _c$7 = web.memo(() => !!(!isMobile() && currentWallet()?.types.includes('desktop')));
                    return () => _c$7() && web.createComponent(Info, {
                      border: true,
                      get title() {
                        return `Connect with ${currentWallet()?.name} Desktop App`;
                      },
                  ...
                  web.insert(_el$12, (() => {
                    var _c$8 = web.memo(() => !!(!isMobile() && codeQR().length > 0 && currentWallet()?.types.includes('ios') && currentWallet()?.types.length > 1));
                    return () => _c$8() && web.createComponent(QRCode, {
                      isMobile: false
                    });
                  })(), null);
                  web.insert(_el$12, (() => {
                    var _c$9 = web.memo(() => !!(!isMobile() && codeQR().length > 0 && currentWallet()?.types.includes('ios') && currentWallet()?.types.length <= 1));
                    return () => _c$9() && web.createComponent(QRCode, {
                      isMobile: true
                    });
                  })(), null);
                  web.insert(_el$12, (() => {
                    var _c$10 = web.memo(() => !!(isMobile() && currentWallet()?.types.includes('ios')));
                    return () => _c$10() && (!currentWallet()?.supportedInteractionStandards?.includes('wallet_connect') || isWCWorking() ? web.createComponent(Info, {
                      border: true,
                      get title() {
                        return `Connect with ${currentWallet()?.name} Mobile`;
                      },
                      description: '',
                      buttons: [{
                        label: 'Use App',
                        ...
                        onClick: async () => {
                          ...
                          if (wallet.supportedInteractionStandards?.includes('wallet_connect')) {
                            ...
                            syncCode = await new beaconCore.Serializer().serialize(await p2pPayload);
                          }
                          handleDeepLinking(wallet, syncCode);
                        }
                      }],
                      get downloadLink() {
                        return currentWallet()?.name.toLowerCase().includes('kukai') && isIOS(window) ? {
                  ...
                  web.effect(_$p => web.style(_el$12, currentInfo() === 'install' || currentInfo() === 'qr' ? {
                    opacity: 1,
                    height: 'unset',
                    overflow: 'unset',
                    transform: 'scale(1)',
              ...
              web.insert(_el$8, (() => {
                var _c$4 = web.memo(() => currentInfo() === 'qr');
                return () => _c$4() && (() => {
                  var _el$13 = _tmpl$4$1();
                  web.insert(_el$13, (() => {
                    var _c$11 = web.memo(() => !!!displayQrExtra());
                    return () => _c$11() ? web.createComponent(PairOther, {
                      get walletList() {
                        return walletList();
                      },
                      onClickLearnMore: handleClickLearnMore,
                      ...
                      wcPayload: wcPayload
                    }) : web.createComponent(QRCode, {
                      isMobile: true
                    });
                  })());
                  web.effect(_$p => web.style(_el$13, currentInfo() === 'install' || currentInfo() === 'qr' ? {
                    opacity: 1,
                    height: 'unset',
                    overflow: 'unset',
                    transform: 'scale(1)',
              ...
              web.insert(_el$9, web.createComponent(Wallets, {
                get wallets() {
              ...
              web.insert(_el$10, areMetricsEnabled && web.createComponent(BugReportForm, {
                onSubmit: () => {
                  handleCloseAlert();
                }
              }), null);
              web.insert(_el$10, !areMetricsEnabled && [web.createComponent(Info, {
                iconBadge: true,
                get icon() {
                  return _tmpl$6$1();
                },
              ...
              web.insert(_el$11, web.createComponent(TopWallets, {
                get wallets() {
              ...
              web.effect(_p$ => {
                ...
                _p$.e = web.style(_el$9, _v$, _p$.e);
                _p$.t = web.style(_el$10, _v$2, _p$.t);
                _p$.a = web.style(_el$11, _v$3, _p$.a);
                return _p$;
              }, {
                e: undefined,
                t: undefined,
          ...
          get onBackClick() {
            return web.memo(() => currentInfo() === 'install')() ? () => setCurrentInfo('top-wallets') : web.memo(() => currentInfo() === 'qr')() ? () => setCurrentInfo('top-wallets') : web.memo(() => !!(currentInfo() === 'wallets' && isMobile()))() ? () => setCurrentInfo('top-wallets') : currentInfo() === 'help' ? () => {
              if (pairingExpired()) {
                handleCloseAlert();
                return;
              }
      ...
      web.insert(_el$7, (() => {
        var _c$2 = web.memo(() => !!!config.pairingPayload);
...
const Toast = props => {
  ...
  return (() => {
    ...
    web.insert(_el$5, (() => {
      var _c$ = web.memo(() => !!(hasWalletObject && props.walletInfo));
      return () => _c$() && web.memo(() => parseWallet(props.label, props.walletInfo));
    })(), _el$6);
    web.insert(_el$5, !hasWalletObject && _tmpl$5(), _el$6);
    web.insert(_el$5, (() => {
      var _c$2 = web.memo(() => !!(!isMobileOS(window) && props.openWalletAction));
      return () => _c$2() && (() => {
        var _el$8 = _tmpl$6();
        _el$8.$$click = () => {
    ...
    web.insert(_el$4, (() => {
      var _c$3 = web.memo(() => !!(props.actions && showMoreInfo()));
      return () => _c$3() && (() => {
        var _el$9 = _tmpl$7();
        web.insert(_el$9, web.createComponent(solidJs.For, {
          ...
          children: action => (() => {
            ...
            web.insert(_el$10, (() => {
              var _c$4 = web.memo(() => !!action.actionText);
              return () => _c$4() && (() => {
                var _el$12 = _tmpl$9();
                _el$12.$$click = () => {
    ...
    web.effect(_p$ => {
      var _v$ = `${divPosition().x}px`,
        _v$2 = `${divPosition().y}px`,
        _v$3 = props.open ? 'toast-wrapper-show' : 'toast-wrapper-hide';
      _v$ !== _p$.e && ((_p$.e = _v$) != null ? _el$4.style.setProperty("left", _v$) : _el$4.style.removeProperty("left"));
...
exports.currentBrowser = currentBrowser;
